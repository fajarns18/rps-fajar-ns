            ...
            <div class="container-fluid card">
                <div>
                    ...
                    <div class="card-body border shadow-sm p-3 mb-3 bg-white rounded">
                        ...
                        <form action="<?= base_url('user/editmateri/') . $datarps['id_materi']; ?>" class="row g-3" method="POST">
                            <div class="col-md-6">
                                <label for="pertemuan" class="form-label">Pertemuan/Minggu</label>
                                <input type="text" class="bg-light input form-control" name="pertemuan" value="<?= $datarps['pertemuan']; ?>">
                            </div>
                            <div class="col-md-6">
                                <label for="penilaian" class="form-label">Penilaian</label>
                                <input type="text" class="bg-light input form-control" name="penilaian" value="<?= $datarps['penilaian']; ?>">
                            </div>
                            <div class="col-md-6">
                                <label for="indikator_materi" class="form-label">Indikator</label>
                                <textarea type="text" class="bg-light input form-control" rows="3" name="indikator_materi"><?= $datarps['indikator_materi']; ?></textarea>
                            </div>
                            <div class="col-md-6">
                                <label for="topik" class="form-label">Topik & Sub Topik</label>
                                <textarea type="text" class="bg-light input form-control" rows="3" name="topik"><?= $datarps['topik']; ?></textarea>
                            </div>
                            <div class="col-md-6">
                                <label for="aktivitas_pembelajaran" class="form-label">Aktivitas dan Strategi Pembelajaran</label>
                                <textarea type="text" class="bg-light input form-control" rows="3" name="aktivitas_pembelajaran"><?= $datarps['aktivitas_pembelajaran']; ?></textarea>
                            </div>
                            <div class="col-md-6">
                                <label for="waktu_matkul" class="form-label">Waktu</label>
                                <input type="text" class="bg-light input form-control" name="waktu_matkul" value="<?= $datarps['waktu_matkul']; ?>">
                            </div>
                            <div class="col-md-6">
                                <label for="kemampuan_akhir" class="form-label">Kemampuan Akhir yang Diharapkan</label>
                                <textarea type="text" class="bg-light input form-control" rows="3" name="kemampuan_akhir"><?= $datarps['kemampuan_akhir']; ?></textarea>
                            </div>
                            <div class="col-12">
                            </div>
                            <div class="col-12">
