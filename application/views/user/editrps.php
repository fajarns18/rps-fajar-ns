<div class="container-fluid">
    ...
    <div class="content bg-white border shadow-sm p-3 mb-5 bg-white rounded">
        ...
        <!-- body rps -->
        <!-- Header RPS -->
        <form action="<?= base_url('user/editrps/') . $datarps['id_rps']; ?>" method="post">
                    ...
                    <div class="form-row mx-2 my-2" style="">
                        <div class="col-md-6">
                            ...
                            <select name="program_studi" class="form-select">
                                <option selected><?= $datarps['program_studi']; ?></option>
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" class="input form-control" name="kode" value="<?= $datarps['kode']; ?>">
                        </div>
                        <div class="col-6">
                            <label for="mata_kuliah" class="form-label">Mata Kuliah</label>
                            <input type="text" class="input form-control" name="mata_kuliah" value="<?= $datarps['mata_kuliah']; ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="semester" class="form-label">Semester</label>
                            <select name="semester" class="form-select">
                                <option selected><?= $datarps['semester']; ?></option>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="input form-control" name="sks" value="<?= $datarps['sks']; ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="deskripsi" class="form-label">Deskripsi</label>
                            <textarea name="deskripsi" class="input form-control"><?= $datarps['deskripsi']; ?></textarea>
                        </div>
                        <div class="row">
                            <div class="col"><br>
                            </div>
                ...
                <div class="row bg-light border tab-pane" id="gambaran">
                    <div class="form-row mx-2 my-2">
                        <div class="col">
                            ...
                            <textarea name="gambaran_umum" class="input form-control"><?= $datarps['gambaran_umum']; ?></textarea>
                        </div>
                ...
                <div class="row bg-light border tab-pane" id="capaian">
                    <div class="form-row mx-2 my-2">
                        <div class="col">
                            ...
                            <textarea name="capaian_pembelajaran" class="input form-control"><?= $datarps['capaian_pembelajaran']; ?></textarea>
                        </div>
                        <div class="row">
                            <div class="col"><br>
                            </div>
                ...
                <div class="row bg-light border tab-pane" id="prasyarat">
                    <div class="form-row mx-2 my-2">
                        <div class="col">
                            ...
                            <textarea name="prasyarat" class="input form-control"><?= $datarps['prasyarat']; ?></textarea>
                        </div>
                        <div class="row">
                            <div class="col"><br>
                            </div>
                ...
                <div class="row bg-light border tab-pane" id="unit">
                    <div class="form-row mx-2 my-2">
                        <div class="col-6">
                            ...
                            <textarea name="kemampuan" class="input form-control"><?= $datarps['kemampuan']; ?></textarea>
                        </div>
                        <div class="col-6">
                            <label for="indikator" class="form-label">Indikator</label>
                            <textarea name="indikator" class="input form-control"><?= $datarps['indikator']; ?></textarea>
                        </div>
                        <div class="col-md-6">
                            <label for="bahan_kajian" class="form-label">Bahan Kajian</label>
                            <textarea name="bahan_kajian" class="input form-control"><?= $datarps['bahan_kajian']; ?></textarea>
                        </div>
                        <div class="col-md-6">
                            <label for="metode_pembelajaran" class="form-label">Metode Pembelajaran</label>
                            <input type="text" class="input form-control" name="metode_pembelajaran" value="<?= $datarps['metode_pembelajaran']; ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="waktu" class="form-label">Waktu</label>
                            <input type="text" class="input form-control" name="waktu" value="<?= $datarps['waktu']; ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="metode_penilaian" class="form-label">Metode Penilaian</label>
                            <input type="text" class="input form-control" name="metode_penilaian" value="<?= $datarps['metode_penilaian']; ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="bahan_ajar" class="form-label">Bahan Ajar</label>
                            <input type="text" class="input form-control" name="bahan_ajar" value="<?= $datarps['bahan_ajar']; ?>">
                        </div>
                        <div class="row">
                            <div class="col"><br>
                            </div>
                ...
                <div class="row bg-light border tab-pane" id="aktivitas">
                    <div class="form-row mx-2 my-2">
                        <div class="col-6">
                            ...
                            <textarea name="aktivitas" class="input form-control"><?= $datarps['aktivitas']; ?></textarea>
                        </div>
                        <div class="col-6">
                            <label for="waktu_tugas" class="form-label">Waktu</label>
                            <input type="text" class="input form-control" name="waktu_tugas" value="<?= $datarps['waktu_tugas']; ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="bobot" class="form-label">Bobot</label>
                            <input type="text" class="input form-control" name="bobot" value="<?= $datarps['bobot']; ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="kriteria" class="form-label">Kriteria Penilaian</label>
                            <input type="text" class="input form-control" name="kriteria" value="<?= $datarps['kriteria']; ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="indikator_penilaian" class="form-label">Indikator Penilaian</label>
                            <textarea name="indikator_penilaian" class="input form-control"><?= $datarps['indikator_penilaian']; ?></textarea>
                        </div>
                        <div class="row">
                            <div class="col"><br>
                            </div>
                ...
                <div class="row bg-light border tab-pane" id="referensi">
                    <div class="form-row mx-2 my-2">
                        <div class="col">
                            ...
                            <textarea name="referensi" class="input form-control"><?= $datarps['referensi']; ?></textarea>
                        </div>
                        <div class="row">
                            <div class="col"><br>
                            </div>
